            ...
            <div className="space-y-4">
              ...
              <div className="w-full">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-2 bg-white border-2 border-gray-300 text-gray-700 py-3 px-4 rounded-md hover:bg-gray-50 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                >
                  ...
                  <span>{loading ? 'Signing in...' : (isRegister ? 'Sign up with Google' : 'Sign in with Google')}</span>
                </button>
              </div>
